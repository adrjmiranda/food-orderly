      ...
      <div class="col">
        ...
        <div class="input-field">
          ...
          <textarea name="description" id="description" placeholder="Description of the dish"
            rows="4"><?= !empty($values["description"]) ? $values["description"] : "" ?></textarea>
        ...
        <div class="input-field">
          ...
          <input type="text" name="price" id="price" placeholder="Price of the dish"
            value="<?= !empty($values["price"]) ? $values["price"] : "" ?>">
        ...
        <div class="input-field">
          ...
          <select name="category" id="category">
            ...
            <?php foreach ($categories as $category): ?>
              <option value="<?= $category->id ?>" <?= $values["category"] === $category->id ? "selected" : "" ?>>
                <?= $category->name ?>
              </option>
            <?php endforeach; ?>
          </select>
